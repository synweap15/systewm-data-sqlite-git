...
struct sqlite3_api_routines {
  ...
  int (SQLITE_APICALL *auto_extension)(int(SQLITE_CALLBACK *)(sqlite3*,char**,const sqlite3_api_routines*));
  ...
  int (SQLITE_APICALL *cancel_auto_extension)(int(SQLITE_CALLBACK *)(sqlite3*,char**,
